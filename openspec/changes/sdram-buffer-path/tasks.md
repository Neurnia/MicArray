...
- [ ] 3.6 Add the first PLL-generated SDRAM clock domain under `Sdram.sv` and connect the SDRAM-side FIFO read path, scheduler, controller, and chip clock output to it
