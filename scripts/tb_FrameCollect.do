# do file for tb_FrameCollect.sv
...
vlog -work work -sv [file join $FRONTEND_DIR FrameCollect.sv]
vlog -work work -sv [file join $SIM_DIR tb_FrameCollect.sv]

# simulation
vsim work.tb_FrameCollect
